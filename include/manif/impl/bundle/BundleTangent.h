...
struct traits<BundleTangent<_Scalar, _T...>>
{
  ...
  static constexpr auto DoFIdx = compute_indices<_T<_Scalar>::Tangent::DoF ...>();
  static constexpr auto RepSizeIdx = compute_indices<_T<_Scalar>::Tangent::RepSize ...>();
  static constexpr auto AlgIdx = compute_indices<_T<_Scalar>::Tangent::LieAlg::RowsAtCompileTime ...>();
  ...
  using Ints = std::array<int, sizeof...(_T)>;

  static constexpr int Dim = accumulate(Ints{_T<_Scalar>::Tangent::Dim ...});
  static constexpr int DoF = accumulate(Ints{_T<_Scalar>::Tangent::DoF ...});
  static constexpr int RepSize = accumulate(Ints{_T<_Scalar>::Tangent::RepSize ...});

  using DataType = Eigen::Matrix<Scalar, RepSize, 1>;
  using Jacobian = Eigen::Matrix<Scalar, DoF, DoF>;
  using LieAlg = SquareMatrix<
    Scalar,
    accumulate(Ints{_T<_Scalar>::Tangent::LieAlg::RowsAtCompileTime ...})
  >;
};
