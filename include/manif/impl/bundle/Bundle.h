...
struct traits<Bundle<_Scalar, _T ...>>
{
  ...
  static constexpr auto DimIdx = compute_indices<_T<_Scalar>::Dim ...>();
  static constexpr auto DoFIdx = compute_indices<_T<_Scalar>::DoF ...>();
  static constexpr auto RepSizeIdx = compute_indices<_T<_Scalar>::RepSize ...>();
  static constexpr auto TraIdx = compute_indices<_T<_Scalar>::Transformation::RowsAtCompileTime ...>();
  ...
  using Ints = std::array<int, BundleSize>;

  static constexpr int Dim = accumulate(Ints{_T<_Scalar>::Dim ...});
  static constexpr int DoF = accumulate(Ints{_T<_Scalar>::DoF ...});
  static constexpr int RepSize = accumulate(Ints{_T<_Scalar>::RepSize ...});
  ...
  using Transformation = SquareMatrix<
    _Scalar,
    accumulate(Ints{_T<_Scalar>::Transformation::RowsAtCompileTime ...})
  >;
